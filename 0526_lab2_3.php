<?php
   ...
   //session_start() 一般放在網頁的最上方還沒有輸出任何東西之前,不然容易發生錯誤
   ...
   $cartObj=new Cart($memnerObj);  //陣列

   //$var1 = 10;  寫在這是錯誤的,當執行17行的$var++;伺服器並不會記錄到,而是記錄到10
   ...
   $cartObj->addItem('P001',3);  //將商品加入到購物車
